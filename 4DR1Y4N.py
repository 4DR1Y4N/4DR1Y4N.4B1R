...
\033[1;93m ⌦ AUTHOR      : ADRIYAN [ ADRIYAN ABIR ]

\033[1;93m ⌦ BEST FRIEND : ABIR CHOWDHURY [ ABIR ]

\033[1;94m ⌦ WHATSAPP    : ADRIYAN ABIR

\033[1;95m ⌦ FACEBOOK    : ADRIYAN ABIR

\033[1;97m ⌦ VERSION     : 0.0.2
...
class __xxx__:
    ...
    def __metode__(self, user, __chi__, cebok):
        ...
        sys.stdout.write(f"\r \x1b[1;96m[ A B I R] {loop}|{len(self.id)} [OK][{len(ok)}] [CP][{len(cp)}] ")
        ...
        try:
            ...
            for pw in __chi__:
                ...
                if 'c_user' in session.cookies.get_dict():
                    ...
                    print('\r%s ╚══[ABIR-CHECKPOINT] %s | %s ' % (M, user, pw))
